						...
						<form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
							<div className="rounded-md shadow-sm -space-y-px">
								<div>
									...
									/>
									{errors.name && (
										<p className="mt-2 text-xs text-red-600">Please enter your name</p>
									)}
								</div>
								<div>
									...
									{errors.email?.type === 'required' && (
										<p className="mt-2 text-xs text-red-600">Please enter your email address</p>
									)}
								...
								<div>
									...
									/>
									{errors.message && (
										<p className="mt-2 text-xs text-red-600">Please enter a message</p>
									)}
								</div>
							</div>
							<div>
